function calc_nonmarketdamages(p, v, d, t, annual_year, r)
    ...
    if v.i_regionalimpact_ann[yr,r] <= p.impmax_maxtempriseforadaptpolicyNM[r]
        ...
        v.isat_ImpactinclSaturationandAdaptation_ann[yr,r] = temp * (1 - (p.imp_actualreduction_ann[yr,r] / 100) * p.impmax_maxtempriseforadaptpolicyNM[r] / v.i_regionalimpact_ann[yr,r])
    end
