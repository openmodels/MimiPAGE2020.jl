function calc_PermafrostSiBCASA(p, v, d, t, annual_year)
    # setting the year for entry in lists.
    yr = annual_year - 2015 + 1 # + 1 because of 1-based indexing in Julia
    yp = 1

    # Permafrost temperature
    v.perm_sib_temp_ann[year] = p.rt_g_ann[year] * p.perm_sib_af
    # Correction for perm sensitivity, CO2
    v.perm_sib_sens_c_co2_correct_ann[year] = ifelse(1 + p.perm_sib_sens_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t <= 0, 0.000001, 1 + p.perm_sib_sens_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t)
    # Correction for perm lag, CO2
    v.perm_sib_lag_c_co2_correct_ann[year] = ifelse(1 + p.perm_sib_lag_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t <= 0, 0.000001, 1 + p.perm_sib_lag_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t)
    # Correction for perm power, CO2
    if is_first(t)
        v.perm_sib_pow_c_co2_correct_ann[year] = ifelse(1 + p.perm_sib_pow_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t <= 0, 0.000001, 1 + p.perm_sib_pow_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t)
    else
        v.perm_sib_pow_c_co2_correct_ann[year] = ifelse(1 + p.perm_sib_pow_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t <= 0, 0.000001, 1 + p.perm_sib_pow_slope_vs_t_co2 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t)
    end
    # Equilibrium perm cumul carbon, CO2
    v.perm_sib_equilib_c_co2_ann[year] = ifelse((p.perm_sib_sens_c_co2 * v.perm_sib_sens_c_co2_correct_ann[year]) * v.perm_sib_temp_ann[year] < p.perm_sib_limit_c, (p.perm_sib_sens_c_co2 * v.perm_sib_sens_c_co2_correct_ann[year]) * v.perm_sib_temp_ann[year], p.perm_sib_limit_c)
    # Released perm cumul carbon, CO2
    if is_first(t)
        v.perm_sib_ce_c_co2_ann[year] = ((v.perm_sib_equilib_c_co2_ann[year] <  p.perm_sib_ce_c_co2_0) ? p.perm_sib_ce_c_co2_0 : (( ((v.perm_sib_equilib_c_co2_ann[year] - p.perm_sib_ce_c_co2_0)/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) < (1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) * yp / (p.perm_sib_lag_c_co2*v.perm_sib_lag_c_co2_correct_ann[year])) ? v.perm_sib_equilib_c_co2_ann[year] : ( v.perm_sib_equilib_c_co2_ann[year] - p.perm_sib_limit_c * ( ( ((v.perm_sib_equilib_c_co2_ann[year] - p.perm_sib_ce_c_co2_0)/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) - (1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) * yp / (p.perm_sib_lag_c_co2*v.perm_sib_lag_c_co2_correct_ann[year]) )^( 1/(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) ) ) ) ) )
    else
        v.perm_sib_ce_c_co2_ann[year] = ((v.perm_sib_equilib_c_co2_ann[year] <  v.perm_sib_ce_c_co2_ann[year-1]) ? v.perm_sib_ce_c_co2_ann[year-1] : (( ((v.perm_sib_equilib_c_co2_ann[year] - v.perm_sib_ce_c_co2_ann[year-1])/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) < (1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) * yp / (p.perm_sib_lag_c_co2*v.perm_sib_lag_c_co2_correct_ann[year])) ? v.perm_sib_equilib_c_co2_ann[year] : ( v.perm_sib_equilib_c_co2_ann[year] - p.perm_sib_limit_c * ( ( ((v.perm_sib_equilib_c_co2_ann[year] - v.perm_sib_ce_c_co2_ann[year-1])/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) - (1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) * yp / (p.perm_sib_lag_c_co2*v.perm_sib_lag_c_co2_correct_ann[year]) )^( 1/(1-(1+p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) ) ) ) ) )
    end
    # Released perm cumulative CO2
    v.perm_sib_ce_co2_ann[year] = v.perm_sib_ce_c_co2_ann[year] * (44. / 12.)
# Annual emissions CO2 perm
    v.perm_sib_e_co2_ann[year] = (44/12) * (p.perm_sib_limit_c / (p.perm_sib_lag_c_co2 * v.perm_sib_lag_c_co2_correct_ann[year])) * ( ((v.perm_sib_equilib_c_co2_ann[year] > v.perm_sib_ce_c_co2_ann[year]) ? ((v.perm_sib_equilib_c_co2_ann[year] - v.perm_sib_ce_c_co2_ann[year])/p.perm_sib_limit_c)^((1 + p.perm_sib_pow_c_co2)*v.perm_sib_pow_c_co2_correct_ann[year]) : 0) )

    # Correction for perm sensitivity, CH4
    v.perm_sib_sens_c_ch4_correct_ann[year] = (v.perm_sib_temp_ann[year]/(0.5*p.perm_sib_limit_t))^p.perm_sib_sens_slope_vs_t_ch4
    # Correction for perm lag, CH4
    v.perm_sib_lag_c_ch4_correct_ann[year] = (v.perm_sib_temp_ann[year]/(0.5*p.perm_sib_limit_t))^p.perm_sib_lag_slope_vs_t_ch4
    # Correction for perm power, CH4
    v.perm_sib_pow_c_ch4_correct_ann[year] = ifelse(1 + p.perm_sib_pow_slope_vs_t_ch4 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t <= 0, 0.000001, 1 + p.perm_sib_pow_slope_vs_t_ch4 * (v.perm_sib_temp_ann[year] - 0.5*p.perm_sib_limit_t) /p.perm_sib_limit_t)
    # Equilibrium perm cumul carbon, CH4
    v.perm_sib_equilib_c_ch4_ann[year] = ifelse((p.perm_sib_sens_c_ch4 * v.perm_sib_sens_c_ch4_correct_ann[year]) * v.perm_sib_temp_ann[year] < p.perm_sib_limit_c, (p.perm_sib_sens_c_ch4 * v.perm_sib_sens_c_ch4_correct_ann[year]) * v.perm_sib_temp_ann[year], p.perm_sib_limit_c)
    # Released perm cumul carbon, CH4
    if is_first(t)
        v.perm_sib_ce_c_ch4_ann[year] = ((v.perm_sib_equilib_c_ch4_ann[year] <  p.perm_sib_ce_c_ch4_0) ? p.perm_sib_ce_c_ch4_0 : (( ((v.perm_sib_equilib_c_ch4_ann[year] - p.perm_sib_ce_c_ch4_0)/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) < (1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) * yp / (p.perm_sib_lag_c_ch4*v.perm_sib_lag_c_ch4_correct_ann[year])) ? v.perm_sib_equilib_c_ch4_ann[year] : ( v.perm_sib_equilib_c_ch4_ann[year] - p.perm_sib_limit_c * ( ( ((v.perm_sib_equilib_c_ch4_ann[year] - p.perm_sib_ce_c_ch4_0)/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) - (1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) * yp / (p.perm_sib_lag_c_ch4*v.perm_sib_lag_c_ch4_correct_ann[year]) )^( 1/(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) ) ) ) ) )
    else
        v.perm_sib_ce_c_ch4_ann[year] = ((v.perm_sib_equilib_c_ch4_ann[year] <  v.perm_sib_ce_c_ch4_ann[year-1]) ? v.perm_sib_ce_c_ch4_ann[year-1] : (( ((v.perm_sib_equilib_c_ch4_ann[year] - v.perm_sib_ce_c_ch4_ann[year-1])/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) < (1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) * yp / (p.perm_sib_lag_c_ch4*v.perm_sib_lag_c_ch4_correct_ann[year])) ? v.perm_sib_equilib_c_ch4_ann[year] : ( v.perm_sib_equilib_c_ch4_ann[year] - p.perm_sib_limit_c * ( ( ((v.perm_sib_equilib_c_ch4_ann[year] - v.perm_sib_ce_c_ch4_ann[year-1])/p.perm_sib_limit_c)^(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) - (1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) * yp / (p.perm_sib_lag_c_ch4*v.perm_sib_lag_c_ch4_correct_ann[year]) )^( 1/(1-(1+p.perm_sib_pow_c_ch4)*v.perm_sib_pow_c_ch4_correct_ann[year]) ) ) ) ) )
    end
    # Released perm cumulative CH4
    v.perm_sib_ce_ch4_ann[year] = v.perm_sib_ce_c_ch4_ann[year] * (16/12)
...
@defcomp PermafrostSiBCASA begin
    ...
    perm_sib_temp_ann = Variable(index=[year], unit="degreeC")
    perm_sib_sens_c_co2_correct = Variable(index=[time])
    perm_sib_sens_c_co2_correct_ann = Variable(index=[year])
    perm_sib_lag_c_co2_correct = Variable(index=[time])
    perm_sib_lag_c_co2_correct_ann = Variable(index=[year])
    perm_sib_pow_c_co2_correct = Variable(index=[time])
    perm_sib_pow_c_co2_correct_ann = Variable(index=[year])
    perm_sib_equilib_c_co2 = Variable(index=[time])
    perm_sib_equilib_c_co2_ann = Variable(index=[year])
    perm_sib_ce_c_co2 = Variable(index=[time], unit="MtonneC")
    perm_sib_ce_c_co2_ann = Variable(index=[year], unit="MtonneC")
    perm_sib_ce_co2 = Variable(index=[time], unit="Mtonne CO2")
    perm_sib_ce_co2_ann = Variable(index=[year], unit="Mtonne CO2")
    perm_sib_e_co2 = Variable(index=[time], unit="MtonCO2/yr")
    perm_sib_e_co2_ann = Variable(index=[year], unit="MtonCO2/yr")
    perm_sib_sens_c_ch4_correct = Variable(index=[time])
    perm_sib_sens_c_ch4_correct_ann = Variable(index=[year])
    perm_sib_lag_c_ch4_correct = Variable(index=[time])
    perm_sib_lag_c_ch4_correct_ann = Variable(index=[year])
    perm_sib_pow_c_ch4_correct = Variable(index=[time])
    perm_sib_pow_c_ch4_correct_ann = Variable(index=[year])
    perm_sib_equilib_c_ch4 = Variable(index=[time], unit="Mtonne C")
    perm_sib_equilib_c_ch4_ann = Variable(index=[year], unit="Mtonne C")
    perm_sib_ce_c_ch4 = Variable(index=[time], unit="Mtonne C")
    perm_sib_ce_c_ch4_ann = Variable(index=[year], unit="Mtonne C")
    perm_sib_ce_ch4 = Variable(index=[time], unit="Mtonne CH4")
    perm_sib_ce_ch4_ann = Variable(index=[year], unit="Mtonne CH4")
    ...
    function run_timestep(p, v, d, tt)
        ...
        if is_first(t)
            for annual_year = 2015:(gettime(t))
                calc_PermafrostSiBCASA(p, v, d, t, annual_year)
            end
        else
