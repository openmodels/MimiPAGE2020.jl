@defcomp co2forcing begin
    ...
    function run_timestep(p, v, d, t)
        # eq.13 in Hope 2006
        # the max() condition was added to prevent numerical issues due to  non-positive CO2 concentration levels which occurs in 2300 for low-emission scenarios if the growth effects are paired with GDP-emission feedback
