...
function buildpage(m::Model, scenario::String, use_permafrost::Bool=true, use_seaice::Bool=false, use_page09damages::Bool=false)
    ...
    # TODO: TAKE ALL CHANGES OF PERMAFROST & CO2 + CH4 ANNUALISATION from climate_model_annual to here.
    ...
    if use_permafrost
        ...
        permafrost_sibcasa[:rt_g_ann] = climtemp[:rt_g_globaltemperature_ann]
        permafrost_jules[:rt_g] = climtemp[:rt_g_globaltemperature]
        permafrost_jules[:rt_g_ann] = climtemp[:rt_g_globaltemperature_ann]
        permafrost[:perm_sib_ce_co2] = permafrost_sibcasa[:perm_sib_ce_co2]
        permafrost[:perm_sib_ce_co2_ann] = permafrost_sibcasa[:perm_sib_ce_co2_ann]
        permafrost[:perm_sib_e_co2] = permafrost_sibcasa[:perm_sib_e_co2]
        permafrost[:perm_sib_e_co2_ann] = permafrost_sibcasa[:perm_sib_e_co2_ann]
        permafrost[:perm_sib_ce_ch4] = permafrost_sibcasa[:perm_sib_ce_ch4]
        permafrost[:perm_sib_ce_ch4_ann] = permafrost_sibcasa[:perm_sib_ce_ch4_ann]
        permafrost[:perm_jul_ce_co2] = permafrost_jules[:perm_jul_ce_co2]
        permafrost[:perm_jul_ce_co2_ann] = permafrost_jules[:perm_jul_ce_co2_ann]
        permafrost[:perm_jul_e_co2] = permafrost_jules[:perm_jul_e_co2]
        permafrost[:perm_jul_e_co2_ann] = permafrost_jules[:perm_jul_e_co2_ann]
        permafrost[:perm_jul_ce_ch4] = permafrost_jules[:perm_jul_ce_ch4]
        permafrost[:perm_jul_ce_ch4_ann] = permafrost_jules[:perm_jul_ce_ch4_ann]
    end
