...
function buildpage(m::Model, scenario::String, use_permafrost::Bool=true)
    ...
    connect_param!(m, :TotalAdaptationCosts => :rt_g_globaltemperature, :ClimateTemperature => :rt_g_globaltemperature)
    ...
    connect_param!(m, :NonMarketDamages => :rt_g_globaltemperature, :ClimateTemperature => :rt_g_globaltemperature)
