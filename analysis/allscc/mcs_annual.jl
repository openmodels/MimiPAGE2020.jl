...
function getsim()
    mcs = @defsim begin
        ...
        # CO2cycle.CO2cycle.ccf_CO2feedback = TriangularDist(0, 0, 0) # only usable if lb <> ub
        ...
        ClimateTemperature.ClimateTemperature.alb_emulator_rand = TriangularDist(-1., 1., 0.)
        ...
        # GDP
        GSP.isat0_initialimpactfxnsaturation = TriangularDist(15, 25, 20)
