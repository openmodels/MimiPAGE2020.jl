...
function getsim()
    mcs = @defsim begin
        ...
        # NonMarketDamages
        NonMarketDamages.tcal_CalibrationTemp = TriangularDist(2.5, 3.5, 3.)
        ...
        ClimateTemperature_ARvariability_tvarseed_coefficientsrandomseed = Uniform(1, 10^10)
        ...
        save(
             ...
             ClimateTemperature_ARvariability.rt_g_globaltemperature_ann,
...
function reformat_RV_outputs(samplesize::Int; output_path::String=joinpath(@__DIR__, "../../output"))
    ...
    rt_g_ann    = load_RV("ClimateTemperature_ARvariability_rt_g_globaltemperature_ann", "rt_g_globaltemperature_ann"; output_path=output_path)
...
function do_monte_carlo_runs(samplesize::Int, scenario::String="RCP4.5 & SSP2", output_path::String=joinpath(@__DIR__, "../output/output"))
    # get simulation
    mcs = getsim()
